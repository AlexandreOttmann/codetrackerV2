      ...
      >
        <div className='h-full px-3 py-4 overflow-y-auto backdrop-blur-2xl sm:backdrop-blur:none	sm:bg-slate-900  bg-opacity-90   shadow'>
          <ul className='space-y-2'>
            ...
            <li>
              <a href='#' className='flex items-center p-2 text-base font-normal text-gray-200 hover:text-white   rounded-lg  hover:bg-gray-500  '>
                <svg aria-hidden='true' className='w-6 h-6 text-gray-500  transition duration-75   ' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
            ...
            <li>
              <a href='#' className='flex items-center p-2 text-base font-normal text-gray-200 group-hover:text-white rounded-lg  hover:bg-gray-500  '>
                <svg aria-hidden='true' className='flex-shrink-0 w-6 h-6 text-gray-500  transition duration-75   ' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
            ...
            <li>
              <a href='/' onClick={() => signOut(auth)} className='flex items-center p-2 text-base font-normal text-gray-200 hover:text-white rounded-lg  hover:bg-gray-500'>
                <svg
                  aria-hidden='true'
                  className='flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75  group-hover:text-gray-900 '
                  fill='currentColor'
