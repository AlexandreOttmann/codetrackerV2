    ...
    <div className="h-full px-3 py-4 overflow-y-auto backdrop-blur-2xl  sm:backdrop-blur:none	sm:bg-slate-900  bg-opacity-90   shadow">
     <ul className="space-y-2">
      <li>
       <div className="flex flex-col items-center justify-center p-2 text-base  font-normal backdrop-blur-2xl text-gray-200 ">
        ...
        <span className="ml-3 text-zinc-700  sm:text-gray-200">
         Bonjour {user.auth.currentUser?.displayName}
        </span>
       </div>
      </li>
      ...
      <li>
       <Link
        to="/"
        className="flex items-center p-2 text-base font-normal text-zinc-700 sm:text-gray-200   rounded-lg  hover:bg-gray-500 "
       >
        <svg
         xmlns="http://www.w3.org/2000/svg"
         fill="none"
      ...
      <li>
       <a
        href="#"
        className="flex items-center p-2 text-base font-normal text-zinc-700 sm:text-gray-200 group-hover:text-white rounded-lg  hover:bg-gray-500  "
       >
        <svg
         aria-hidden="true"
         className="flex-shrink-0 w-6 h-6 text-gray-300"
      ...
      <li>
       <Link
        to="#"
        className="flex items-center p-2 text-base font-normal text-zinc-700 sm:text-gray-200 hover:text-white rounded-lg  hover:bg-gray-500  "
       >
        <svg
         aria-hidden="true"
         className="flex-shrink-0 w-6 h-6 text-gray-300"
