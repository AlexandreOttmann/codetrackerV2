...
const featuresData = [
  {
    ...
    description: "Un dashboard personnalisé vous permettra de suivre tous vos projets Github en un coup d'oeil.",
    image: dashboard,
  ...
  },
  {
    ...
    description: "Parce qu'apprendre et resté motivé est la clef de la réussite, vous aurez votre ressenti à chaque session.",
    image: happy,
  ...
  },
  {
    ...
    description: 'Vous pourrez suivre vos progès et rester motivé grâce à des statistiques claires et précises.',
    image: solution,
