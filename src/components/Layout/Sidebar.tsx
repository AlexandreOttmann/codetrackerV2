      ...
      <div className='p-4 sm:ml-64 '>
        <div className='p-4 border-2 border-gray-200 border-dashed rounded-lg '>
          <div className='flex flex-col sm:grid grid-cols-1 gap-4 mb-4'>
            <div className='flex items-center justify-center h-16 rounded bg-gray-50 '>
              <p className='text-2xl text-gray-400 '>Search bar </p>
            </div>
          </div>

          <div className='md:grid grid-cols-3 gap-4 mb-4'>
            <div className='flex items-center justify-center h-48 mb-4 rounded bg-gray-50 '>
              <p className='text-2xl text-gray-400 '>Mood</p>
            </div>
            <div className='flex items-center col-span-2 justify-center h-36 mb-4 rounded bg-gray-50 '>
              <p className='text-2xl text-gray-400 '>Projets & Commits</p>
            </div>
          </div>
          <div className='grid grid-cols-1 gap-4 mb-4'>
            <div className='flex items-start justify-center rounded bg-gray-50 h-[100vh] '>
              <p className='text-2xl text-gray-400   '>Liste des Projets </p>
            </div>
          </div>
        </div>
      </div>
